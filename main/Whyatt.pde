...
void wW(int o, int p) { image(WhyattW, x, y); }
void wA(int o, int p) { image(WhyattA, x, y); }
void wS(int o, int p) { image(WhyattS, x, y); }
void wD(int o, int p) { image(WhyattD, x, y); }

void wW1(int o, int p) { image(WhyattWw1, x, y); }
void wW2(int o, int p) { image(WhyattWw2, x, y); }

void wA1(int o, int p) { image(WhyattAw1, x, y); }
void wA2(int o, int p) { image(WhyattAw2, x, y); }
void wA3(int o, int p) { image(WhyattAw3, x, y); }
void wA4(int o, int p) { image(WhyattAw4, x, y); }

void wS1(int o, int p) { image(WhyattSw1, x, y); }
void wS2(int o, int p) { image(WhyattSw2, x, y); }

void wD1(int o, int p) { image(WhyattDw1, x, y); }
void wD2(int o, int p) { image(WhyattDw2, x, y); }
void wD3(int o, int p) { image(WhyattDw3, x, y); }
void wD4(int o, int p) { image(WhyattDw4, x, y); }
